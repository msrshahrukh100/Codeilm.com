...
def send_motivation(from_user_id, to_user_id, group_id):
	...
	group = mooc_models.MoocGroup.objects.get(id=group_id)
	mooc_models.MoocGroupUserMotivation.objects.create(to_user=to_user, from_user=from_user, group=group)
	...
	add_activity(from_user.id, 'mooc-motivation-sent')
