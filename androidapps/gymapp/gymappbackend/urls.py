...
urlpatterns = [
    ...
    path('gymapp/api/schedules/<slug:schedule_hash_id>', gym_views.ScheduleDetail.as_view(), name="schedule-detail"),
    path('gymapp/api/schedules/<slug:schedule_hash_id>/exercises', gym_views.ScheduleExerciseList.as_view(), name="schedule-exercise-list"),
